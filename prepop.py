...
#startvoting
pv1= PollVote(voteid='1', userid='00000002', pollid='1', playerid='1')
pv2= PollVote(voteid='2', userid='00000004', pollid='1', playerid='1')
pv3= PollVote(voteid='3', userid='00000005', pollid='1', playerid='4')

pv4= PollVote(voteid='4', userid='00000006', pollid='2', playerid='6')
pv5= PollVote(voteid='5', userid='00000002', pollid='2', playerid='7')
pv6= PollVote(voteid='6', userid='00000001', pollid='2', playerid='9')

pv7= PollVote(voteid='7', userid='00000002', pollid='3', playerid='12')
pv8= PollVote(voteid='8', userid='00000003', pollid='3', playerid='12')
pv9= PollVote(voteid='9', userid='00000001', pollid='3', playerid='12')
db.session.add(pv1)
db.session.add(pv2)
db.session.add(pv3)
db.session.add(pv4)
