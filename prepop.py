...
#startvoting
pv1= PollVote(voteid='1', userid='00000001', pollid='1', playerid='4')
pv2= PollVote(voteid='2', userid='00000002', pollid='1', playerid='4')
pv3= PollVote(voteid='3', userid='00000003', pollid='1', playerid='4')
pv4= PollVote(voteid='4', userid='00000004', pollid='1', playerid='4')
pv5= PollVote(voteid='5', userid='00000005', pollid='1', playerid='6')
pv6= PollVote(voteid='6', userid='00000006', pollid='1', playerid='6')
pv7= PollVote(voteid='7', userid='00000007', pollid='1', playerid='6')
pv8= PollVote(voteid='8', userid='00000008', pollid='1', playerid='10')
pv9= PollVote(voteid='9', userid='00000009', pollid='1', playerid='12')

pv10= PollVote(voteid='10', userid='00000001', pollid='2', playerid='3')
pv11= PollVote(voteid='11', userid='00000009', pollid='2', playerid='3')
pv12= PollVote(voteid='12', userid='00000006', pollid='2', playerid='13')
pv13= PollVote(voteid='13', userid='00000004', pollid='2', playerid='3')
pv14= PollVote(voteid='14', userid='00000002', pollid='2', playerid='14')


pv15= PollVote(voteid='15', userid='00000004', pollid='3', playerid='5')
pv16= PollVote(voteid='16', userid='00000005', pollid='3', playerid='5')
pv17= PollVote(voteid='17', userid='00000006', pollid='3', playerid='7')
pv18= PollVote(voteid='18', userid='00000007', pollid='3', playerid='7')
pv19= PollVote(voteid='19', userid='00000008', pollid='3', playerid='9')
pv20= PollVote(voteid='20', userid='00000009', pollid='3', playerid='16')
...
#count votes
pp1 = PollPlayer(pollplayerid ='1', pollid='1', playerid='4', votecount ='4')
pp2 = PollPlayer(pollplayerid ='2', pollid='1', playerid='6', votecount ='3')
pp3 = PollPlayer(pollplayerid ='3', pollid='1', playerid='10', votecount ='1')
pp10 = PollPlayer(pollplayerid ='4', pollid='1', playerid='12', votecount ='1')
pp11 = PollPlayer(pollplayerid ='5', pollid='1', playerid='16', votecount ='0')


pp4 = PollPlayer(pollplayerid ='6', pollid='2', playerid='3', votecount ='3')
pp5 = PollPlayer(pollplayerid ='7', pollid='2', playerid='13', votecount ='1')
pp6 = PollPlayer(pollplayerid ='8', pollid='2', playerid='14', votecount ='1')

pp7 = PollPlayer(pollplayerid ='9', pollid='3', playerid='5', votecount ='2')
pp8 = PollPlayer(pollplayerid ='10', pollid='3', playerid='7', votecount ='2')
pp9 = PollPlayer(pollplayerid ='11', pollid='3', playerid='9', votecount ='1')
pp12 = PollPlayer(pollplayerid ='12', pollid='3', playerid='16', votecount ='1')
